...
parser.add_argument("-f", "--format", help="example format: (csv|pickle|tfr)",
                    choices=["csv", "pickle", "tfr"], default="tfr")
parser.add_argument(
...
parser.add_argument("-p", "--driver_ps_nodes",
                    help="run tensorflow PS node on driver locally", default=False)
