...
parser.add_argument("--batch_size", help="number of elements per batch", type=int, default=100)
parser.add_argument("--cluster_size", help="number of nodes in cluster", type=int, default=num_executors)
...
parser.add_argument("--rdma", help="use RDMA", action="store_true")
...
args.mode = "train"
args.images = "examples/mnist/csv/train/images"
args.labels = "examples/mnist/csv/train/labels"
dataRDD = createRDD(args)
...
print("{0} ===== Test".format(datetime.now().isoformat()))
args.mode = "inference"
#args.images = "examples/mnist/csv/test/images"
#args.labels = "examples/mnist/csv/test/labels"
#dataRDD = createRDD(args)
