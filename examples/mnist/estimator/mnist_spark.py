...
if __name__ == "__main__":
  ...
  cluster = TFCluster.run(sc, main, args, args.cluster_size, num_ps=0, tensorboard=args.tensorboard, input_mode=TFCluster.InputMode.SPARK, log_dir=args.model_dir, master_node='chief')
