...
parser.add_argument("--inference_mode", help="type of inferencing (none|signature|direct|checkpoint)",
                    choices=["none", "signature", "direct", "checkpoint"], default="none")
...
# INFER FROM TENSORFLOW CHECKPOINT
  ...
  # load model from checkpoint at args.model_dir
